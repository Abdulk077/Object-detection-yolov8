...
columns = ["frame", "class_name", "tracker_id", "confidence", "x1", "y1", "x2", "y2"]
...
# Save DataFrame to CSV for overview
detections_df.to_csv("detections_overview.csv", index=False)
print("Saved detection overview to detections_overview.csv")
